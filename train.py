...
def main():
    ...
    # Initialize MLflow
    mlflow.set_tracking_uri("http://localhost:5000")  # Change this to your MLflow server URL
    mlflow.set_experiment("XrayGPT")
    mlflow.start_run(run_name=f"train_{job_id}")
